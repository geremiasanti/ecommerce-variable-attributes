...
function Header() {
    return (
        <div className="flex items-center">
            ...
            <Link className="text-white bg-green-600 md:bg-green-500 hover:bg-green-600 text-font-bold p-3 rounded inline-flex items-center ml-auto">
...
function CategoryRow({category}) {
    return (
        <li className="h-10 md:h-20 flex bg-white shadow-xl rounded-lg mb-1 md:mb-2 p-1 md:p-2">
            <img className="rounded-l-lg" src={category.image_path} />
            <span className="text-l md:text-3xl truncate my-auto mx-2">{category.name}</span>
            <Link className="text-white bg-blue-600 md:bg-blue-500 hover:bg-blue-600 text-font-bold rounded inline-flex items-center ml-auto">
                <svg className="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <Link className="text-white bg-red-600 md:bg-red-500 hover:bg-red-600 text-font-bold rounded inline-flex items-center">
                <svg className="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
