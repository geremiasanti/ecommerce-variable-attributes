...
function Header() {
    return (
        <div className="flex items-center">
            ...
            <Link class="text-white bg-green-600 md:bg-green-500 hover:bg-green-600 text-font-bold p-3 rounded inline-flex items-center ml-auto">
                <svg class="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2" stroke="white" strokeWidth="2"/>
                </svg>
...
function CategoryRow({category}) {
    return (
        <li className="flex m-2 p-4 bg-white shadow rounded-lg">
            <img className="w-10 md:w-20 rounded-l-lg" src={category.image_path} />
            <span className="my-auto text-xl md:text-3xl m-2 truncate">{category.name}</span>
            <Link class="text-white bg-blue-600 md:bg-blue-500 hover:bg-blue-600 text-font-bold m-0 md:my-3 px-4 rounded inline-flex items-center ml-auto">
                <svg class="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <Link class="text-white bg-red-600 md:bg-red-500 hover:bg-red-600 text-font-bold m-0 md:my-3 ml-2 px-4 rounded inline-flex items-center">
                <svg class="fill-current w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
